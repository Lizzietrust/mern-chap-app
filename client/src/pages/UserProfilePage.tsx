                    ...
                    {!isCurrentUser && (
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 cursor-pointer flex items-center gap-2 transition-colors"
                          title="Audio Call"
                        >
                          <svg
                            className="w-5 h-5"
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 cursor-pointer flex items-center gap-2 transition-colors"
                          title="Video Call"
                        >
                          <svg
                            className="w-5 h-5"
                        ...
                        <button
                          ...
                          className="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 cursor-pointer flex items-center gap-2 transition-colors"
                        >
                          <svg
                            className="w-5 h-5"
                            fill="none"
